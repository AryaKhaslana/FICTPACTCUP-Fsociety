  ...
  return (
    <section className="relative w-full h-[90vh] flex items-center justify-center text-center px-4 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 max-w-3xl mx-auto mt-10">
        ...
        {/* JUDUL UTAMA */}
        <h1 
          className="text-5xl md:text-[58px] tracking-wide leading-tight text-transparent bg-clip-text bg-gradient-to-b from-[#FFE140] to-[#E6940B] [-webkit-text-stroke:1px_black] md:[-webkit-text-stroke:2px_black] drop-shadow-[0_4px_4px_rgba(0,0,0,0.8)]"
