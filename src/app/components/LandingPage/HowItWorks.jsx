    ...
    <div className="min-h-screen bg-[#070714] flex flex-col">
      ...
      <section className="relative w-full flex flex-col items-center justify-center overflow-hidden">
        <div className="relative w-full h-[500px] md:h-[700px]">
          ...
          <button
            type="button"
            className="mt-4 px-10 py-3 bg-[#FFB800] hover:bg-[#E6A600] text-black font-pixellari text-lg rounded-md transition-all shadow-[0_4px_0_0_#996E00] hover:shadow-[0_2px_0_0_#996E00] hover:translate-y-1 active:translate-y-2 active:shadow-none"
          >
